...
<p align="center">引言，我想说的话：</p>

<p align="center"><em><font size=2">你是否会因为 b 站收藏有数量限制，亦或者是搜索不好用而感到烦恼？我不知道有多少人和我一样，有这些问题：根据记忆里的关键词，检索不到曾经看过的视频，以及在收藏夹上限后，他们迫不得已转向其他方式记录：web 端或是改成浏览器收藏夹记录，app 端或是改用截图保存，再有甚者忍痛割爱删除曾经的收藏夹......</font></em></p>
